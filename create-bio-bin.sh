...
PATH=$PATH:$BIOINF_PREFIX/map/FastQC
PATH=$PATH:$BIOINF_PREFIX/map/sratoolkit/bin
PATH=$PATH:$BIOINF_PREFIX/map/bbmap
PATH=$PATH:$BIOINF_PREFIX/map/bowtie2
PATH=$PATH:$BIOINF_PREFIX/map/bowtie
PATH=$PATH:$BIOINF_PREFIX/map/samtools/bin
PATH=$PATH:$BIOINF_PREFIX/map/bcftools/bin
#PATH=$PATH:$BIOINF_PREFIX/map/ont-guppy/bin
PATH=$PATH:$BIOINF_PREFIX/map/ont-guppy-cpu/bin
